...
import me.luckyraven.compatibility.version.pathfinding.PathfindingHandler_v1_21_R4;
import me.luckyraven.compatibility.version.recoil.Recoil_1_21_R4;

public class v1_21_R4 implements Compatibility {

	private final RecoilCompatibility recoilCompatibility;
	private final PathfindingHandler  pathfindingHandler;

	public v1_21_R4() {
		this.recoilCompatibility = new Recoil_1_21_R4();
		this.pathfindingHandler  = new PathfindingHandler_v1_21_R4();
	}
