...
| HG | keystone-hologram | ArmorStand holograms (Phase H10, added 2026-09-24) | keystone-hologram: org/luckyraven/keystone/hologram/** | - | HologramService, Hologram | Entity lifecycle (spawn/despawn/teleport across chunk unload and reload), per-consumer registry, protection listener registration, line updates |
