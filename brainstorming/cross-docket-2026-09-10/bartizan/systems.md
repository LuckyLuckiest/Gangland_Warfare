...
| EF | effects-status | Effects & status (gates HA/HB, added 2026-09-24) | bartizan-plugin: effect/**, status/** | bartizan-api: api/weapon/dto/Effect*, StatusData, status events | - | EffectRunner, EffectContext, *HookEffect, StatusEffectService, ActiveStatus | hooks that never fire, effects on protected targets, per-entity maps, console command dispatch |
| IM | importer | WeaponMechanics importer (gate HM, added 2026-09-24) | bartizan-plugin: importer/wm/**, command/WmImportCommand | - | WmWeaponImporter, WmMechanicsTranslator, WmYamlEmitter, WmItemConverterListener | emitted YAML vs parser, file writes, live item conversion |
| HU | hud-stats | HUD, placeholders & stats (gates HK/HN, added 2026-09-24) | bartizan-plugin: hud/**, stats/** | - | HudService, BartizanExpansion, WeaponPlaceholders, StatsService, StatsListener | async PAPI threads, per-player bars/tasks, kill credit, stats persistence |
