 ...
 * that need to render both halves of an unclaimed two-phase capture (e.g. the dual bossbar UI) the event also
 * carries the active {@link #getPhase() phase} plus split {@link #getClaimProgress() claim} /
