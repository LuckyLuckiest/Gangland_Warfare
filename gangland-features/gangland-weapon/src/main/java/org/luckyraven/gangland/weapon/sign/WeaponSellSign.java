...
public class WeaponSellSign extends AbstractWeaponTradeSign {

	private final UserManager<Player> userManager;
	private final SignType            signType;

	public WeaponSellSign(UserManager<Player> userManager, WeaponService weaponService,
	...
	public SignTypeDefinition createDefinition() {
		...
		SignAspect itemAspect = new ItemTransferAspect(sign -> getWeaponItem(sign.getContent()),
		                                               ItemTransferAspect.TransferType.TAKE, weaponSimilarityChecker());
