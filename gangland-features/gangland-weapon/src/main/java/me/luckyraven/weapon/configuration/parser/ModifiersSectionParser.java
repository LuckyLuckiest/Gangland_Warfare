 ...
 * Mirrors the static-utility shape of {@link SelectiveFireSectionParser} — the call site in
 * {@link me.luckyraven.weapon.configuration.WeaponAddon} simply delegates to
 * {@link #apply(NodeReader, Weapon, ConfigReport)}.
 *
