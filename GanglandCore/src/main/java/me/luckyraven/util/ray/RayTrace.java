...
public class RayTrace {
	...
	public List<RayTraceResult> cast(World world, Vector start, Vector end, Vector direction,
		...
		if (!hits.isEmpty()) {
			...
			// If more than 1 hit, sort based on distance traveled (lowest to highest)
...
//					entityBox.outlineAllBoxes(entity);
	...
	private void getBlockHits(List<RayTraceResult> hits, World world, Vector start, Vector end, Vector direction,
							  double maximumBlockThrough) {
