...
public class LootChestDuringCrackingEvent extends LootChestEvent implements Cancellable {
	...
	public LootChestDuringCrackingEvent(LootChestData lootChestData, CrackingSession crackingSession) {
		super(lootChestData);
