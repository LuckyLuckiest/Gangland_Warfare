...
public class LootChestCrackingFailureEvent extends LootChestEvent implements Cancellable {
	...
	public LootChestCrackingFailureEvent(LootChestData lootChestData, CrackingSession crackingSession) {
		super(lootChestData);
