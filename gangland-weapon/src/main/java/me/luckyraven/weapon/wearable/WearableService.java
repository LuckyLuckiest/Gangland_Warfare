...
public class WearableService {
	 ...
	 *
	 * <p>The {@link me.luckyraven.util.item.wearable.WearableTrait#REACTIVE} trait is checked
	...
	/**
	 * Reduces the bonus damage added by a critical hit, based on the
	 * {@link me.luckyraven.util.item.wearable.WearableTrait#TOUGHENED} trait across all worn pieces.
	 *
	...
	/**
	 * Reduces the number of fire ticks to be applied to the target, based on the
	 * {@link me.luckyraven.util.item.wearable.WearableTrait#FIRE_RESISTANT} trait and the vanilla
	 * {@code FIRE_PROTECTION} enchantment across all worn armor pieces.
	 *
