...
| 3  | [Dependency Injection](./dependency-injection.md) | DI container, autowiring, listener discovery, registration flow   |
...
| Topic                          | Location                                                    |
|--------------------------------|-------------------------------------------------------------|
| How initialization works       | [Architecture -> Initialization Flow](./architecture.md)    |
...
| How DI wires listeners         | [DI -> Listener Auto-Discovery](./dependency-injection.md)  |
...
| Dependency Injection    | `gangland-core` -- DependencyContainer                      |
