...
public @interface Bean {
	 ...
	 * {@link me.luckyraven.persistence.repository.Repository#isGeneric()}. When {@code true}, consumers must inject the
	 * bean via {@link Qualifier} rather than relying on raw-class lookup.
	 */
