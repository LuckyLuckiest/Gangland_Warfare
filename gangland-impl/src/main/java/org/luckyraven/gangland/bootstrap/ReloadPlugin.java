 ...
 *
 * <p>Convenience methods ({@link #filesReload()}, {@link #inventoryReload()}) support the sub-command variants
 * ({@code /glw reload files}, etc.) that only reload a subset of the plugin.
 */
@CustomLog
public final class ReloadPlugin {
	 ...
	 *     <li>UserManager stops timers</li>
