 ...
 *
 * <p>WS4 G1a (B3): relocated bodily from {@code gangland-ui/shop-api} — still on {@code MultiPanelInventory}/
 * inventory-api unchanged; only the shop-domain imports ({@code BarterCategory}/{@code SellCategory}/
 * {@code ShopDefinition}/{@code ShopEditedEvent}) now come from {@code keystone-shop}. The Oriel/{@code MenuFlow}
 * rewrite is G1b's job.
 */
