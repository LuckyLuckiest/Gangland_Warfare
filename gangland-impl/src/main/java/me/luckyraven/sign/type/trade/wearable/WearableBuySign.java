...
public class WearableBuySign extends BaseTradeSign implements BulkSignHandler {
	...
	public WearableBuySign(UserManager<Player> userManager, WearableService wearableService,
						   WeaponService weaponService, AmmunitionAddon ammunitionAddon, SignType signType) {
