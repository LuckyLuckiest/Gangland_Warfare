...
public class WantedAddCommand extends SubArgument {
	...
	private void wantedValue() {
		Argument optional = new OptionalArgument(tree, (argument, sender, args) -> {
			...
			if (wanted.getLevel() + realAmount > wanted.getMaxLevel())
				realAmount = wanted.getMaxLevel() - wanted.getLevel();
