package me.luckyraven.gang.vault.permission;
...
public final class VaultPermissionBridge {
	...
	public static void onRankTransition(UUID uuid, @Nullable Rank oldRank, @Nullable Rank newRank) {
		...
		if (oldRank != null) {
			for (me.luckyraven.gang.rank.Permission perm : oldRank.getPermissions()) {
		...
		if (newRank != null) {
			for (me.luckyraven.gang.rank.Permission perm : newRank.getPermissions()) {
