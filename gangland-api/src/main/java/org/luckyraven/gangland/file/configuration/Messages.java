...
public enum Messages {
	...
	BANK_RESETCAP_SUCCESS("Commands.Bank.Reset_Cap.Player", Type.COMMAND),
	BANK_RESETCAP_ALL_SUCCESS("Commands.Bank.Reset_Cap.All", Type.COMMAND),

	// commands - banker NPC
	BANKER_DEPOSIT_SUCCESS("Commands.Banker.Deposit_Success", Type.COMMAND),
	BANKER_WITHDRAW_SUCCESS("Commands.Banker.Withdraw_Success", Type.COMMAND),
	BANKER_UPGRADE_SUCCESS("Commands.Banker.Upgrade_Success", Type.COMMAND),
	BANKER_REMOVED("Commands.Banker.Removed", Type.COMMAND),
	BANKER_RENAMED("Commands.Banker.Renamed", Type.COMMAND),
	BANKER_NO_ACCOUNT("Errors.Banker.No_Account", Type.ERROR),
	...
	BANKER_TIER_MISSING("Errors.Banker.Tier_Missing", Type.ERROR),
	BANKER_NAME_EMPTY("Errors.Banker.Name_Empty", Type.ERROR),
	...
	BANKER_CREATE_NAME_EMPTY("Errors.Banker.Create_Name_Empty", Type.ERROR),
	...
	GANG_INVITE_EXPIRES_ONLINE("Commands.Gang.Invite.Expires_Online", Type.COMMAND),
	GANG_INVITE_NO_EXPIRY("Commands.Gang.Invite.No_Expiry", Type.COMMAND),
	GANG_INVITE_ACCEPT("Commands.Gang.Invite.Accept", Type.COMMAND),
	GANG_INVITE_ALREADY_SENT("Information.Gang.Invite_Already_Sent", Type.INFORMATION),
	GANG_INVITE_ACCEPT_MULTIPLE("Commands.Gang.Invite.Accept_Multiple", Type.COMMAND),
	GANG_INVITE_CANCEL_MULTIPLE("Commands.Gang.Invite.Cancel.Multiple", Type.COMMAND),
	GANG_INVITE_NO_INVITE_FROM("Commands.Gang.Invite.No_Invite_From", Type.COMMAND),
	GANG_INVITE_PENDING_NONE("Commands.Gang.Invite.Pending.None", Type.COMMAND),
	GANG_INVITE_PENDING_HEADER("Commands.Gang.Invite.Pending.Header", Type.COMMAND),
	GANG_INVITE_PENDING_ENTRY("Commands.Gang.Invite.Pending.Entry", Type.COMMAND),
	GANG_INVITE_CANCEL_NONE("Commands.Gang.Invite.Cancel.None", Type.COMMAND),
	GANG_INVITE_CANCEL_SENDER("Commands.Gang.Invite.Cancel.Sender", Type.COMMAND),
	GANG_INVITE_CANCEL_TARGET("Commands.Gang.Invite.Cancel.Target", Type.COMMAND),
	GANG_PLAYER_JOINED("Commands.Gang.Invite.Joined", Type.COMMAND),
	GANG_LEAVE("Commands.Gang.Leave.Left", Type.COMMAND),
	GANG_PLAYER_LEFT("Commands.Gang.Leave.Broadcast", Type.COMMAND),
	GANG_TRANSFER_OWNERSHIP("Commands.Gang.Leave.Owner_Rank", Type.COMMAND),
	GANG_TRANSFER_REQUEST("Commands.Gang.Transfer.Request", Type.COMMAND),
	GANG_TRANSFER_PLAYER_SUCCESS("Commands.Gang.Transfer.Player_Success", Type.COMMAND),
	GANG_TRANSFER_TARGET_SUCCESS("Commands.Gang.Transfer.Target_Success", Type.COMMAND),
	GANG_TRANSFER_NO_PARENT("Commands.Gang.Transfer.No_Parent", Type.ERROR),
	GANG_CANNOT_ACT_SELF("Errors.Gang.Cannot_Act_Self", Type.ERROR),
	...
	GANG_ALLY_ACCEPT_MULTIPLE("Commands.Gang.Ally.Accept_Multiple", Type.COMMAND),
	GANG_ALLY_REJECT_MULTIPLE("Commands.Gang.Ally.Reject_Multiple", Type.COMMAND),
	GANG_ALLY_NO_REQUEST_FROM("Commands.Gang.Ally.No_Request_From", Type.COMMAND),
	GANG_ALLY_PENDING_NONE("Commands.Gang.Ally.Pending.None", Type.COMMAND),
	GANG_ALLY_PENDING_HEADER("Commands.Gang.Ally.Pending.Header", Type.COMMAND),
	GANG_ALLY_PENDING_ENTRY("Commands.Gang.Ally.Pending.Entry", Type.COMMAND),
	GANG_ALLY_PENDING_CANCEL_NONE("Commands.Gang.Ally.Pending.Cancel.None", Type.COMMAND),
	GANG_ALLY_PENDING_CANCEL_SENDER("Commands.Gang.Ally.Pending.Cancel.Sender", Type.COMMAND),
	...
	DETAINMENT_TRANSIT_STARTING_ACTION_BAR("Cops_N_Crooks.Detainment.Transit.Starting_Action_Bar", Type.OTHER),
	DETAINMENT_TRANSIT_COMMITTED_TITLE("Cops_N_Crooks.Detainment.Transit.Committed_Title", Type.OTHER),
	DETAINMENT_TRANSIT_COMMITTED_SUBTITLE("Cops_N_Crooks.Detainment.Transit.Committed_Subtitle", Type.OTHER),
	DETAINMENT_HANDCUFF_BRIBE_GUI_TITLE("Cops_N_Crooks.Detainment.Handcuff_Bribe.Gui_Title", Type.OTHER),
	DETAINMENT_HANDCUFF_BRIBE_BUTTON_LABEL("Cops_N_Crooks.Detainment.Handcuff_Bribe.Button_Label", Type.OTHER),
	DETAINMENT_HANDCUFF_BRIBE_BUTTON_LORE("Cops_N_Crooks.Detainment.Handcuff_Bribe.Button_Lore", Type.OTHER),
	DETAINMENT_HANDCUFF_BRIBE_SUCCESS_TITLE("Cops_N_Crooks.Detainment.Handcuff_Bribe.Success_Title", Type.OTHER),
	DETAINMENT_HANDCUFF_BRIBE_SUCCESS_SUBTITLE("Cops_N_Crooks.Detainment.Handcuff_Bribe.Success_Subtitle", Type.OTHER),
	DETAINMENT_HANDCUFF_BRIBE_INSUFFICIENT("Cops_N_Crooks.Detainment.Handcuff_Bribe.Insufficient", Type.ERROR),
	DETAINMENT_PAPERWORK_ITEM_NAME("Cops_N_Crooks.Detainment.Paperwork.Item_Name", Type.OTHER),
	DETAINMENT_PAPERWORK_ITEM_LORE("Cops_N_Crooks.Detainment.Paperwork.Item_Lore", Type.OTHER),
	DETAINMENT_PAPERWORK_GUI_TITLE("Cops_N_Crooks.Detainment.Paperwork.Gui_Title", Type.OTHER),
	DETAINMENT_PAPERWORK_BAIL_LABEL("Cops_N_Crooks.Detainment.Paperwork.Bail_Label", Type.OTHER),
	DETAINMENT_PAPERWORK_BAIL_LORE("Cops_N_Crooks.Detainment.Paperwork.Bail_Lore", Type.OTHER),
	DETAINMENT_PAPERWORK_BRIBE_LABEL("Cops_N_Crooks.Detainment.Paperwork.Bribe_Label", Type.OTHER),
	DETAINMENT_PAPERWORK_BRIBE_LORE("Cops_N_Crooks.Detainment.Paperwork.Bribe_Lore", Type.OTHER),
	DETAINMENT_PAPERWORK_SENTENCE_LABEL("Cops_N_Crooks.Detainment.Paperwork.Sentence_Label", Type.OTHER),
	DETAINMENT_PAPERWORK_SENTENCE_LORE("Cops_N_Crooks.Detainment.Paperwork.Sentence_Lore", Type.OTHER),
	DETAINMENT_PAPERWORK_INFO_LABEL("Cops_N_Crooks.Detainment.Paperwork.Info_Label", Type.OTHER),
	DETAINMENT_PAPERWORK_INFO_LORE("Cops_N_Crooks.Detainment.Paperwork.Info_Lore", Type.OTHER),
	DETAINMENT_BAIL_SUCCESS("Cops_N_Crooks.Detainment.Bail.Success", Type.INFORMATION),
	DETAINMENT_BAIL_INSUFFICIENT("Cops_N_Crooks.Detainment.Bail.Insufficient", Type.ERROR),
	DETAINMENT_JAIL_BRIBE_SUCCESS("Cops_N_Crooks.Detainment.Jail_Bribe.Success", Type.INFORMATION),
	DETAINMENT_JAIL_BRIBE_FAIL("Cops_N_Crooks.Detainment.Jail_Bribe.Fail", Type.ERROR),
	DETAINMENT_JAIL_BRIBE_INSUFFICIENT("Cops_N_Crooks.Detainment.Jail_Bribe.Insufficient", Type.ERROR),
	DETAINMENT_SENTENCE_TICK_ACTION_BAR("Cops_N_Crooks.Detainment.Sentence.Tick_Action_Bar", Type.OTHER),
	DETAINMENT_SENTENCE_COMPLETE_TITLE("Cops_N_Crooks.Detainment.Sentence.Complete_Title", Type.OTHER),
	DETAINMENT_SENTENCE_COMPLETE_SUBTITLE("Cops_N_Crooks.Detainment.Sentence.Complete_Subtitle", Type.OTHER),
	DETAINMENT_BREAK_FREE_PROGRESS("Cops_N_Crooks.Detainment.Break_Free.Progress_Action_Bar", Type.OTHER),
	DETAINMENT_BREAK_FREE_SUCCESS_TITLE("Cops_N_Crooks.Detainment.Break_Free.Success_Title", Type.OTHER),
	DETAINMENT_BREAK_FREE_SUCCESS_SUBTITLE("Cops_N_Crooks.Detainment.Break_Free.Success_Subtitle", Type.OTHER),
	...
	MODULE_UNKNOWN("Commands.Module.Unknown", Type.COMMAND),
	MODULE_INSTALL_USAGE("Commands.Module.Install_Usage", Type.COMMAND),
	MODULE_INSTALL_STARTED("Commands.Module.Install_Started", Type.COMMAND),
	MODULE_INSTALL_FAILED("Commands.Module.Install_Failed", Type.COMMAND),
	MODULE_INSTALL_NO_VERSION("Commands.Module.Install_No_Version", Type.COMMAND),
	MODULE_INSTALLED("Commands.Module.Installed", Type.COMMAND),
	MODULE_NOT_A_MODULE("Commands.Module.Not_A_Module", Type.COMMAND),
	MODULE_INCOMPATIBLE("Commands.Module.Incompatible", Type.COMMAND),
	MODULE_MISSING_DEPEND("Commands.Module.Missing_Depend", Type.COMMAND),
	MODULE_MISSING_PLUGIN("Commands.Module.Missing_Plugin", Type.COMMAND),
	...
	JAIL_EXIT_SET("Commands.Jail.Exit_Set", Type.COMMAND),
	...
	// commands - turf
	TURF_ENTER_OWNED("Commands.Turf.Enter.Owned", Type.OTHER),
	TURF_ENTER_UNCLAIMED("Commands.Turf.Enter.Unclaimed", Type.OTHER),
	TURF_ENTER_CONTESTING_CLAIM("Commands.Turf.Enter.Contesting_Claim", Type.OTHER),
	TURF_ENTER_CONTESTING_CONSOLIDATE("Commands.Turf.Enter.Contesting_Consolidate", Type.OTHER),
	TURF_EXIT("Commands.Turf.Exit", Type.OTHER),
	TURF_TITLE("Commands.Turf.Enter.Title", Type.OTHER),
	TURF_SUBTITLE_OWNED("Commands.Turf.Enter.Subtitle_Owned", Type.OTHER),
	TURF_SUBTITLE_UNCLAIMED("Commands.Turf.Enter.Subtitle_Unclaimed", Type.OTHER),
	TURF_SUBTITLE_CONTESTING_CLAIM("Commands.Turf.Enter.Subtitle_Contesting_Claim", Type.OTHER),
	TURF_SUBTITLE_CONTESTING_CONSOLIDATE("Commands.Turf.Enter.Subtitle_Contesting_Consolidate", Type.OTHER),
	TURF_PRESENCE_OWNED("Commands.Turf.Presence.Owned", Type.OTHER),
	TURF_PRESENCE_UNCLAIMED("Commands.Turf.Presence.Unclaimed", Type.OTHER),
	TURF_BLOCKED_COOLDOWN("Information.Turf.Blocked.Cooldown", Type.INFORMATION),
	TURF_BLOCKED_PROTECTED("Information.Turf.Blocked.Protected", Type.INFORMATION),
	TURF_INCOME_SUCCESS("Commands.Turf.Income.Success", Type.COMMAND),
	TURF_INCOME_INVALID("Errors.Turf.Income.Invalid", Type.ERROR),
	TURF_POWERUPNPC_SET("Commands.Turf.PowerupNpc.Set", Type.COMMAND),
	...
	TURF_BUFF_ACTIVATED("Commands.Turf.Buff.Activated", Type.COMMAND),
	TURF_BOSSBAR_TITLE("Commands.Turf.Capture.BossBar_Title", Type.OTHER),
	TURF_BOSSBAR_TITLE_UNCLAIMED("Commands.Turf.Capture.Unclaimed_Bossbar_Title", Type.OTHER),
	TURF_COOLDOWN_ACTIONBAR("Commands.Turf.Capture.Cooldown_Actionbar", Type.OTHER),
	TURF_CAPTURED_BROADCAST("Commands.Turf.Capture.Captured_Broadcast", Type.INFORMATION),
	TURF_WAND_GIVEN("Commands.Turf.Wand.Given", Type.COMMAND),
	TURF_POS_SET("Commands.Turf.Wand.Pos_Set", Type.COMMAND),
	TURF_CREATE_SUCCESS("Commands.Turf.Create.Success", Type.COMMAND),
	TURF_DELETE_SUCCESS("Commands.Turf.Delete.Success", Type.COMMAND),
	TURF_SETOWNER_SUCCESS("Commands.Turf.SetOwner.Success", Type.COMMAND),
	TURF_SETOWNER_CLEARED("Commands.Turf.SetOwner.Cleared", Type.COMMAND),
	TURF_SELECTED("Commands.Turf.Select.Success", Type.COMMAND),
	TURF_TP_SUCCESS("Commands.Turf.Tp.Success", Type.COMMAND),
	TURF_SHOW_STARTED("Commands.Turf.Show.Started", Type.COMMAND),
	TURF_INFO_HEADER("Commands.Turf.Info.Header", Type.COMMAND),
	TURF_INFO_OWNER("Commands.Turf.Info.Owner", Type.OTHER),
	TURF_INFO_REGION("Commands.Turf.Info.Region", Type.OTHER),
	TURF_INFO_INCOME("Commands.Turf.Info.Income", Type.OTHER),
	TURF_INFO_STATE("Commands.Turf.Info.State", Type.OTHER),
	TURF_LIST_HEADER("Commands.Turf.List.Header", Type.COMMAND),
	TURF_LIST_ROW("Commands.Turf.List.Row", Type.OTHER),
	TURF_LIST_EMPTY("Commands.Turf.List.Empty", Type.COMMAND),
	TURF_STATUS_IDLE("Commands.Turf.Status.Idle", Type.COMMAND),
	TURF_STATUS_CONTESTING("Commands.Turf.Status.Contesting", Type.COMMAND),
	TURF_STATUS_COOLDOWN("Commands.Turf.Status.Cooldown", Type.COMMAND),

	// information - turf
	TURF_CONTEST_START_DEFENDER("Information.Turf.Contest_Start_Defender", Type.INFORMATION),
	TURF_CONTEST_HALF_DEFENDER("Information.Turf.Contest_Half_Defender", Type.INFORMATION),

	// errors - turf
	TURF_CREATE_FAIL_OVERLAP("Errors.Turf.Create.Overlap", Type.ERROR),
	TURF_CREATE_FAIL_NO_SELECTION("Errors.Turf.Create.No_Selection", Type.ERROR),
	TURF_CREATE_FAIL_CROSS_WORLD("Errors.Turf.Create.Cross_World", Type.ERROR),
	TURF_CREATE_FAIL_ID_TAKEN("Errors.Turf.Create.Id_Taken", Type.ERROR),
	TURF_NOT_FOUND("Errors.Turf.Not_Found", Type.ERROR),
	TURF_NOT_INSIDE("Errors.Turf.Not_Inside", Type.ERROR),
	TURF_GANG_NOT_FOUND("Errors.Turf.Gang_Not_Found", Type.ERROR),
	TURF_NO_GANG("Errors.Turf.No_Gang", Type.ERROR),
	TURF_NO_ACTIVE("Errors.Turf.No_Active", Type.ERROR),
	;
