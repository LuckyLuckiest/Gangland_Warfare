...
public final class SellCategory {
	 ...
	 * (different car models, weapon variants, custom-model-data distinctions, etc.). The template is where per-item NBT
	 * metadata (e.g. the {@code sell_price} tag) lives, so callers that need item-specific pricing go through here.
	 */
