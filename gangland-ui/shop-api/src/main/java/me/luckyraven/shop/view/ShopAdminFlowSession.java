 ...
 * original {@link ShopDefinition} at flow start; a {@link me.luckyraven.shop.event.ShopEditedEvent} is fired on flow
 * end with the rebuilt definition.
 */
public final class ShopAdminFlowSession implements FlowSession {
	 ...
	 * {@link me.luckyraven.shop.event.ShopEditedEvent}.
	 */
